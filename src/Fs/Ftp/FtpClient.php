...
class FtpClient extends FsClientBase
{
	...
	private
        ...
        $ftpUsername,
        /** @var string pass pour le login */
        $ftpPassword,
        /** @var string chemin absolu du répertoire racine du serveur ftp */
        $ftpRootDir,
        /** @var string chemin sur le serveur web pour le stockage des fichiers temporaires (lors du téléchargement de fichiers depuis le ftp) */
        $tmpDir,
        /** @var string chemin vers la racine du serveur ftp */
        $userRootDir;
